function updateProfileData(data){
    ...
    hardSkills.innerHTML = data.skills.hardSkills.map((skills) => `<li><a href="${skills.certificate}"><img src="../src/img/file-text.png" id="btn-certificate"></a><img src="${skills.logo}" alt="${skills.name}"></li>`).join('')
